...
<div class="container marketing">
  ...
  <div class="row">
    <div class="col-md-4 text-center">
      <img class="img-circle" src="images/4.jpg" height=140 width=140 alt="No Preview Available">
      <h2>City Name</h2>
      ...
      <p><a class="btn btn-default" href="../mvc/CoffeeShopSearchController?type=city">City Name »</a></p>
    </div>
    <div class="col-md-4 text-center">
      <img class="img-circle" src="images/5.jpg" height=140 width=140 alt="No Preview Available">
      <h2>Zipcode</h2>
      <p>Want to search by zipcode? Simply enter all or part of a zipcode and we'll do the rest.</p>
      <p><a class="btn btn-default" href="../mvc/CoffeeShopSearchController?type=zipcode">Zipcode »</a></p>
    </div>
    <div class="col-md-4 text-center">
      <img class="img-circle" src="images/6.jpg" height=140 width=140 alt="No Preview Available">
      <h2>Locate Me</h2>
      <p>Give us permission to use your location and we'll let you know which coffee shops are nearby.</p>
      <p><a class="btn btn-default" id="btn-locate" href="../mvc/CoffeeShopSearchController?type=gps">Locate Me »</a></p>
    </div>
  </div><!-- /.row -->
